  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        // Fetch period-based passenger cabins from /api/cabins?type=passenger
        try {
          const cabinsResponse = await cabinsApi.getCabins(1, 100, "", "passenger");
          if (cabinsResponse && cabinsResponse.data && cabinsResponse.data.cabins) {
            setPeriodPassengerCabins(cabinsResponse.data.cabins);
          }
        } catch (error) {
