...
const moduleSubmodules = {
  ...
  "sales-bookings": [
    ...
    { name: "Bookings & Tickets", code: "bookings-tickets", permissions: ["Read", "Write", "Edit", "Delete"] },
    {
  ...
  "checkin-boardings": [
    ...
    { name: "Trip Completion & Closure", code: "trip-completion-closure", permissions: ["Read", "Write"] },
  ],
  finance: [
