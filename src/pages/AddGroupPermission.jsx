...
const moduleSubmodules = {
  ...
  "ship-trips": [
    { name: "Ships", code: "ships", permissions: ["Read", "Write", "Edit", "Delete"] },
    { name: "Trips", code: "trips", permissions: ["Read", "Write", "Edit", "Delete"] },
  ],
  "partners-management": [
  ...
  "sales-bookings": [
    ...
    { name: "Ticketing Rules", code: "ticketing-rules", permissions: ["Read", "Write", "Edit", "Delete"] },
    { name: "Bookings & Tickets", code: "bookings", permissions: ["Read", "Write", "Edit", "Delete"] },
    {
      name: "Excess Baggage Tickets",
      code: "excess-baggage",
      permissions: ["Read", "Write", "Edit", "Delete"],
    },
  ],
  "checkin-boardings": [
    { name: "Passenger Checking In", code: "passenger-checking-in", permissions: ["Read", "Write"] },
    { name: "Cargo Checking In", code: "cargo-checking-in", permissions: ["Read", "Write"] },
    { name: "Vehicle Checking In", code: "vehicle-checking-in", permissions: ["Read", "Write"] },
    { name: "Passenger Boarding", code: "passenger-boarding", permissions: ["Read", "Write"] },
    { name: "Vehicle Boarding", code: "vehicle-boarding", permissions: ["Read", "Write"] },
    { name: "Trip Completion & Closure", code: "trip-completion", permissions: ["Read", "Write"] },
  ],
  finance: [
    ...
    { name: "Agent Top up Deposits", code: "agent-topup", permissions: ["Read", "Write", "Edit", "Delete"] },
