...
// 170+ Country Codes Component
const COMPLETE_COUNTRY_CODES = [
  { code: "+1", country: "USA" },
  ...
  { code: "+246", country: "Ascension Island" },
...
export function CountryCodeSelector({ value, onChange, className = "" }) {
  return (
    <select value={value} onChange={onChange} className={className}>
      ...
      {COMPLETE_COUNTRY_CODES.map((item, index) => (
...
export const countryCodeData = COMPLETE_COUNTRY_CODES
