...
//  * - Dispatches custom events 'dt-delete', 'dt-edit', and 'dt-toggle' on button clicks
//  * - Listens to customers changes and re-inits safely
//  */
// export default function CustomerList({ customers = [], onDelete, onEdit, onToggleStatus }) {
...
//           return `<span class="badge ${isActive ? "bg-success" : "bg-danger"}">${data}</span>`
//         },
//       },
//       {
//         title: "Actions",
...
//                   <button class="btn btn-sm ${isActive ? "btn-warning" : "btn-success"} toggle-status-btn" data-id="${row.id}" data-status="${row.status}">
...
//       } else if (btn.matches && btn.matches(".toggle-status-btn")) {
//         const id = btn.getAttribute("data-id")
//         const status = btn.getAttribute("data-status")
//         if (id != null) window.dispatchEvent(new CustomEvent("dt-toggle", { detail: { id, status } }))
//       }
//     }
...
//     const onDtDelete = (ev) => onDelete?.(ev.detail.id) // Removed Number() conversion for string IDs
//     const onDtEdit = (ev) => onEdit?.(ev.detail.id)
//     const onDtToggle = (ev) => onToggleStatus?.(ev.detail.id, ev.detail.status) // Added toggle listener

//     window.addEventListener("dt-delete", onDtDelete)
//     window.addEventListener("dt-edit", onDtEdit)
//     window.addEventListener("dt-toggle", onDtToggle)
...
//       }
//       try {
//         window.removeEventListener("dt-delete", onDtDelete)
//       } catch (e) {
//         /* ignore */
//       }
//       try {
//         window.removeEventListener("dt-edit", onDtEdit)
//       } catch (e) {
//         /* ignore */
//       }
//       try {
//         window.removeEventListener("dt-toggle", onDtToggle)
//       } catch (e) {
//         /* ignore */
//       }
...
//       }
//     }
//   }, [customers, onDelete, onEdit, onToggleStatus])
...
//             <th className="px-4 py-3 text-center fw-semibold">Status</th>
