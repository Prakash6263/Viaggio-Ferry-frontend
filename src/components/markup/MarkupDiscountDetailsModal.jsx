...
export default function MarkupDiscountDetailsModal({ ruleId, onClose }) {
  ...
  const fetchRuleDetails = async () => {
    ...
    try {
      setLoading(true);
      setError(null);
      console.log("[v0] Fetching markup discount rule details for ID:", ruleId);
  ...
  return (
    <div
      ...
      id="markupDiscountDetailsModal"
      tabIndex="-1"
      aria-labelledby="markupDiscountDetailsModalLabel"
      aria-hidden="true"
    >
      <div className="modal-dialog modal-lg">
        <div className="modal-content">
          ...
          <div className="modal-header">
            <h5 className="modal-title" id="markupDiscountDetailsModalLabel">
              Markup/Discount Rule Details
            </h5>
            <button
              ref={closeButtonRef}
              type="button"
          ...
          <div className="modal-body">
            ...
            {!loading && !error && ruleData && (
              <div className="rule-details">
                ...
                {/* Markup/Discount Information */}
                <div className="row mb-3">
                  <div className="col-md-6">
                    <div className="card-text">
                      <small className="text-muted d-block">Rule Type</small>
                      <strong>{ruleData.ruleType || "N/A"}</strong>
                    </div>
                  </div>
                  <div className="col-md-6">
                    <div className="card-text">
                      <small className="text-muted d-block">Value Type</small>
                      <strong>{ruleData.valueType === "percentage" ? "Percentage (%)" : "Fixed Amount"}</strong>
                    </div>
                  </div>
                </div>
                ...
                <div className="row mb-3">
                  <div className="col-md-6">
                    <div className="card-text">
                      <small className="text-muted d-block">Rule Value</small>
                      <strong>
                        {ruleData.ruleValue}
                        {ruleData.valueType === "percentage" ? "%" : ""}
                      </strong>
                    </div>
                  </div>
                  <div className="col-md-6">
